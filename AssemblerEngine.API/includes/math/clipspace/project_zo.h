...
#ifndef ae_project_zo_h
#define ae_project_zo_h
...
AE_INLINE
void
ae_unprojecti_zo(vec3 pos, mat4 invMat, vec4 vp, vec3 dest) {
  vec4 v;
...
AE_INLINE
void
ae_project_zo(vec3 pos, mat4 m, vec4 vp, vec3 dest) {
