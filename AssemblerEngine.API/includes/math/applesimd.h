...
#ifndef ae_applesimd_h
#define ae_applesimd_h
...
AE_INLINE
simd_float3
ae_vec3_applesimd(vec3 v) {
  return (simd_float3){v[0], v[1], v[2]};
}

#endif
#endif /* ae_applesimd_h */
