...
/*
 ...
 Functions:
   AE_INLINE ae_euler_seq ae_euler_order(int newOrder[3]);
   AE_INLINE void ae_euler_angles(mat4 m, vec3 dest);
   AE_INLINE void ae_euler(vec3 angles, mat4 dest);
   AE_INLINE void ae_euler_xyz(vec3 angles, mat4 dest);
   AE_INLINE void ae_euler_zyx(vec3 angles, mat4 dest);
   AE_INLINE void ae_euler_zxy(vec3 angles, mat4 dest);
   AE_INLINE void ae_euler_xzy(vec3 angles, mat4 dest);
   AE_INLINE void ae_euler_yzx(vec3 angles, mat4 dest);
   AE_INLINE void ae_euler_yxz(vec3 angles, mat4 dest);
   AE_INLINE void ae_euler_by_order(vec3         angles,
                                       ae_euler_seq ord,
                                       mat4         dest);
 */
...
AE_INLINE
ae_euler_seq
ae_euler_order(int ord[3]) {
  return (ae_euler_seq)(ord[0] << 0 | ord[1] << 2 | ord[2] << 4);
}
...
AE_INLINE
void
ae_euler_angles(mat4 m, vec3 dest) {
...
AE_INLINE
void
ae_euler_xyz(vec3 angles, mat4 dest) {
  float cx, cy, cz,
...
AE_INLINE
void
ae_euler(vec3 angles, mat4 dest) {
  ae_euler_xyz(angles, dest);
}
...
AE_INLINE
void
ae_euler_xzy(vec3 angles, mat4 dest) {
  float cx, cy, cz,
...
AE_INLINE
void
ae_euler_yxz(vec3 angles, mat4 dest) {
  float cx, cy, cz,
...
AE_INLINE
void
ae_euler_yzx(vec3 angles, mat4 dest) {
  float cx, cy, cz,
...
AE_INLINE
void
ae_euler_zxy(vec3 angles, mat4 dest) {
  float cx, cy, cz,
...
AE_INLINE
void
ae_euler_zyx(vec3 angles, mat4 dest) {
  float cx, cy, cz,
        sx, sy, sz, czsx, cxcz, sysz;
...
AE_INLINE
void
ae_euler_by_order(vec3 angles, ae_euler_seq ord, mat4 dest) {
  float cx, cy, cz,
        sx, sy, sz;
