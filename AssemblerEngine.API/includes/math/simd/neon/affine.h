...
#ifndef ae_affine_neon_h
#define ae_affine_neon_h
...
AE_INLINE
void
ae_mul_neon(mat4 m1, mat4 m2, mat4 dest) {
  /* D = R * L (Column-Major) */
  ...
  v3 = aem_fmadd(aem_splat_w(r3), aem_load(m1[3]), v3);
...
AE_INLINE
void
ae_mul_rot_neon(mat4 m1, mat4 m2, mat4 dest) {
  /* D = R * L (Column-Major) */
...
AE_INLINE
void
ae_inv_tr_neon(mat4 mat) {
  float32x4x4_t vmat;
  aem_128      r0, r1, r2, r3, x0;
  ...
  x0 = aem_fmadd(r0, aem_splat_w(r0),
                  aem_fmadd(r1, aem_splat_w(r1),
                             vmulq_f32(r2, aem_splat_w(r2))));
  x0 = vnegq_f32(x0);
